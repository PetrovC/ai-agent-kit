---
description: Security audit of the current change or specified files. Triage by severity, only real exploitable issues.
argument-hint: [files-or-scope]
---

Perform a security audit of $ARGUMENTS (or the current change if no scope given).
