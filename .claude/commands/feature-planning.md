---
description: Produce a complete implementation plan for the given GitHub issue. Plan only — does not write code.
argument-hint: <issue-number>
---

Plan the implementation of the feature described in GitHub issue #$ARGUMENTS.
